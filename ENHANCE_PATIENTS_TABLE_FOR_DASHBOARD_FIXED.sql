-- ============================================================================
-- ENHANCE PATIENTS TABLE FOR DASHBOARD (FIXED VERSION - NO INSURANCE DEPENDENCY)
-- ============================================================================
-- This version works WITHOUT requiring patient_insurance table
...
-- ============================================================================
-- VIEW FOR PATIENT DASHBOARD SUMMARY (NO INSURANCE DEPENDENCY)
-- ============================================================================
-- This view works WITHOUT requiring patient_insurance table
-- Insurance info can be added later when the table is created
-- ============================================================================

-- Drop view if it exists (to avoid conflicts)
DROP VIEW IF EXISTS patient_dashboard_summary;

-- Create view WITHOUT insurance dependency
...
SELECT 
    ...
    -- Insurance Info - Will be NULL if patient_insurance table doesn't exist
    -- You can add this later when patient_insurance table is created:
    -- (SELECT primary_insurance_company FROM patient_insurance WHERE patient_id = p.id LIMIT 1) as insurance,
    NULL::VARCHAR as insurance,  -- Placeholder - update when insurance table exists
